...
const THREE = Object.assign(
    {BoxBufferGeometry, ShaderMaterial, Vector3, Mesh, UniformsUtils},
    ThreeConstants);
...
Sky.SkyShader = {
  ...
  fragmentShader: [
    ...
    'const float N = 2.545E25;',  // number of molecules per unit volume for air
                                  // at 288.15K and 1013mb (sea level -45
                                  // celsius)
    ...
    'const float whiteScale = 1.0748724675633854;',  // 1.0 /
                                                     // Uncharted2Tonemap(1000.0)
